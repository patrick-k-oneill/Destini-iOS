...
// Structure for storing prompt, choice, and destination data, as well as methods for retrieving text strings and progressing the story
struct StoryBrain   {
    ...
    // Methods for retrieving choice A & B strings
    ...
    // Checks user's choice (buttonText) for given question (adventure[index]) -> returns the next question's index as an Int
